...
* This script takes about thow hours to complete! 
...
var abortedPrefixes = [],
    ...
    fnameDump = 'boots.com.dump-'+month+day+secondsNow+'.txt',
    fname = 'boots.com-'+month+day+secondsNow+'.txt';
...
casper.eachThen(postcodePrefixes, function stealShopInfo() {
    i++;
    casper.echo("Working on postal prefix number: " + i + "\n" );
...
// Output info to a temporary file for now as a dump
    ...
    // removing null values from shopInfo
