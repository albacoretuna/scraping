...
var baseUrl = 'http://store.api.arcadiagroup.co.uk/storestock/storestock?brand=12552&jsonp_callback=CALLBACK&lat=51.5073509&long=-0.12775829999998223&dist=1000&res=1000&_=1432135370856';
...
casper.then(function saveLogBye(){
 saveToFile(shopInfo, 'dorothy-perkins');
});
