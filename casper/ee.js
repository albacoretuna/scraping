...
var baseUrl = "http://storefinder.ee.co.uk/ee/stores.html";
...
casper.eachThen(prefixes, function stealShopInfo() {
    ...
    // Ontimeout, for afterFormSubmitted
        abortedPrefixes.push(prefixes[i]);
        request.abort();
    });
    
});
casper.then(function() {
    shopInfoUnique = onlyUnique(shopInfo);
    saveToFile(JSON.stringify(shopInfoUnique),"EE");
    casper.echo(JSON.stringify(shopInfo));
